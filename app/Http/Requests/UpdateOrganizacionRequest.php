...
class UpdateOrganizacionRequest extends FormRequest
{
    ...
    {
        $organizacionId = $this->route('organizacion');
        ...
        return [
            ...
            'nombre'               => ['required', 'string', 'max:255', Rule::unique('organizacion', 'nombre')->ignore($organizacionId, 'id_organizacion')],
            'rtn'                  => ['required', 'string', 'max:255', Rule::unique('organizacion', 'rtn')->ignore($organizacionId, 'id_organizacion')],
