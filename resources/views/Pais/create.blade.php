...
<div class="container-fluid max-w-4xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Nuevo País</h1>
        <p class="text-gray-600 dark:text-gray-300 mt-1">Agrega un país al sistema</p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
        <form action="{{ route('pais.store') }}" method="POST">
            ...
            <div class="mt-6 flex justify-end gap-3">
                <a href="{{ route('pais.index') }}" class="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-400 dark:hover:bg-gray-500 transition-colors duration-200">
                    Cancelar
                </a>
