...
<div class="container-fluid max-w-4xl">
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:text-gray-300 mt-1">Registra un nuevo empleado en la organización</p>
    </div>
    ...
    <form action="{{ route('empleado.store') }}" method="POST" id="employeeWizard">
        ...
        <div class="mb-6">
            <div class="flex items-center justify-between relative">
                ...
                @foreach([1 => 'Datos de Persona', 2 => 'Información del Empleado'] as $num => $label)
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            {{-- Step 2: Información del Empleado --}}
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="cargo" id="cargo" value="{{ old('cargo') }}" required 
                            ...
                            placeholder="Ej. Secretaria, Conserje...">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validarStep1() {
            ...
            if (esNuevo) {
                ...
                // Empleado requests require email/telefono? The Miembro one didn't strictly from JS.
                // StoreEmpleadoRequest in PHP requires email/telefono? The user only has them as optional in `Miembro`, but the original `Empleado` form made them check.
                // Looking at `Miembro` logic: it only validates n, a, d, f, s inside JS. We will keep it exactly as `Miembro`.
