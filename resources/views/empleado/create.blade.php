...
<div class="container-fluid max-w-5xl mx-auto pb-12 px-4">
    <div class="text-center mb-10">
        ...
        <p class="mt-3 text-lg text-gray-600 dark:text-gray-400">Siga los pasos para dar de alta a un nuevo colaborador en la organización.</p>
    </div>
    ...
    <div class="flex items-center justify-center gap-4 mb-12 max-w-2xl mx-auto">
        ...
        <div class="flex items-center gap-3">
            ...
            <span id="text-2" class="hidden md:block font-bold text-gray-400 dark:text-gray-500 uppercase text-xs tracking-widest">Información del Empleado</span>
        </div>
    </div>
    ...
    @if($errors->any() && !$errors->has('persona_id'))
        <div class="mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-6 shadow-sm">
            <div class="flex items-center mb-4">
                ...
                <p class="text-red-800 dark:text-red-200 font-bold uppercase text-xs tracking-widest">Favor corregir errores:</p>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-700 rounded-2xl p-8 mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" name="cargo" id="cargo" value="{{ old('cargo') }}" required class="w-full px-4 py-3 rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 focus:ring-blue-500 transition-all shadow-sm" placeholder="Ej. Secretaria, Conserje...">
                        <x-input-error :messages="$errors->get('cargo')" />
                    </div>
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-500 uppercase ml-1 tracking-wider">Frecuencia de Pago *</label>
                        <select name="frecuencia_pago" id="frecuencia_pago" required class="w-full px-4 py-3 rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 focus:ring-blue-500 transition-all shadow-sm">
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-gray-500 uppercase ml-1 tracking-wider">Monto de Sueldo (L.) *</label>
                        <input type="number" step="0.01" name="sueldo_mensual" id="sueldo_mensual" value="{{ old('sueldo_mensual') }}" required class="w-full px-4 py-3 rounded-xl border-gray-200 dark:border-gray-700 dark:bg-gray-900 focus:ring-blue-500 transition-all shadow-sm" placeholder="0.00">
