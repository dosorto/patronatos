...
<div class="container-fluid max-w-4xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Nuevo Departamento</h1>
        <p class="text-gray-600 dark:text-gray-300 mt-1">Agrega un departamento al sistema</p>
    </div>
