...
<div class="container-fluid max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white uppercase tracking-wider">Detalle de Proyecto</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-1 space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:text-white">{{ $proyecto->id }}</p>
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Nombre del Proyecto</label>
                        <p class="text-md font-medium text-gray-900 dark:text-white">{{ $proyecto->nombre_proyecto }}</p>
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Tipo de Proyecto</label>
                        <p class="text-md font-medium text-gray-900 dark:text-white">{{ $proyecto->tipo_proyecto ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Número de Acta</label>
                        <p class="text-md font-medium text-gray-900 dark:text-white">{{ $proyecto->numero_acta ?? 'N/A' }}</p>
                    </div>
                    <div>
                        ...
                        <p class="text-md font-medium text-gray-900 dark:text-white">
                            @if($proyecto->getRawOriginal('estado') == 1)
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-300">Activo</span>
                            @else
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300">Inactivo</span>
                            @endif
                        </p>
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Responsable</label>
                        <p class="text-md font-medium text-gray-900 dark:text-white">
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/30 border-t border-gray-200 dark:border-gray-700">
                    <div class="text-[10px] text-gray-400 flex flex-col gap-1">
                        <span>Creado: {{ $proyecto->created_at->format('d/m/Y H:i') }}</span>
                        <span>Actualizado: {{ $proyecto->updated_at->format('d/m/Y H:i') }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-b border-gray-200 dark:border-gray-700">
                    <h2 class="text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-widest">Fechas</h2>
                </div>
                <div class="p-6 space-y-4">
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Aprobación Asamblea</label>
                        <p class="text-md font-medium text-gray-900 dark:text-white">{{ $proyecto->fecha_aprobacion_asamblea?->format('d/m/Y') ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Fecha Inicio</label>
                        <p class="text-md font-medium text-gray-900 dark:text-white">{{ $proyecto->fecha_inicio?->format('d/m/Y') ?? 'N/A' }}</p>
                    </div>
                    <div>
                        <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Fecha Fin</label>
                        <p class="text-md font-medium text-gray-900 dark:text-white">{{ $proyecto->fecha_fin?->format('d/m/Y') ?? 'N/A' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-900 dark:text-white">{{ $proyecto->descripcion_beneficiarios ?? 'N/A' }}</p>
                    </div>
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Hombres</label>
                            <p class="text-md font-bold text-gray-900 dark:text-white">{{ $proyecto->benef_hombres ?? 0 }}</p>
                        </div>
                        <div>
                            <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Mujeres</label>
                            <p class="text-md font-bold text-gray-900 dark:text-white">{{ $proyecto->benef_mujeres ?? 0 }}</p>
                        </div>
                        <div>
                            <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Niños</label>
                            <p class="text-md font-bold text-gray-900 dark:text-white">{{ $proyecto->benef_ninos ?? 0 }}</p>
                        </div>
                        <div>
                            <label class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-tighter block">Familias</label>
                            <p class="text-md font-bold text-gray-900 dark:text-white">{{ $proyecto->benef_familias ?? 0 }}</p>
                        </div>
                    </div>
                </div>
            </div>
