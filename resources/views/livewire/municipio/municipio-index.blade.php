<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-300 mt-1">Administra el registro de municipios y sus datos básicos</p>
        </div>
                ...
                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                    @forelse($municipios as $municipio)
                        <tr
                            ...
                            onclick="window.location='{{ route('municipio.show', $municipio) }}'"
                        >
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mr-3 shadow-sm group-hover:scale-110 transition-transform">
                                        <span class="text-white text-xs font-bold">{{ strtoupper(substr($municipio->nombre, 0, 2)) }}</span>
                                    </div>
                                    <div>
                            ...
                            <td class="px-6 py-4" onclick="event.stopPropagation()">
                                <div class="flex items-center space-x-2">
                                    @can('municipio.view')
                                        <a href="{{ route('municipio.show', $municipio) }}"
                                    ...
                                    @can('municipio.delete')
                                        <button
                                            wire:click="confirmMunicipioDeletion({{ $municipio->id }}, '{{ $municipio->nombre }}')"
                            ...
                            <td colspan="4" class="px-6 py-16 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-gray-500 dark:text-gray-400 mb-4 max-w-sm">
                                        ...
                                        @else
                                            Comienza agregando los municipios para gestionar la base de datos de manera organizada.
                                        @endif
                                    </p>
                                    @if(!$search)
                                        @can('municipio.create')
                ...
                <div class="p-6">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 dark:text-gray-400">
                            Estás a punto de eliminar <span class="font-semibold text-gray-900 dark:text-white">{{ $municipioNameBeingDeleted }}</span>.
