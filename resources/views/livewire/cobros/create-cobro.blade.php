        ...
        <div class="px-8 pb-8 space-y-6">
            ...
            <div class="bg-surface-container-low dark:bg-slate-800 rounded-xl border border-outline-variant/10 overflow-hidden">
                <div class="p-5 border-b border-outline-variant/10 flex items-center gap-3">
                    ...
                    <h3 class="font-bold text-on-surface dark:text-white">Agregar Servicio</h3>
                </div>
                <div class="p-6">
                    <div class="flex flex-col sm:flex-row gap-3">
                        <select
                            wire:model="selectedServicioId"
                            class="flex-1 px-4 py-2.5 border border-outline-variant/30 rounded-lg bg-surface-container dark:bg-slate-700 text-on-surface dark:text-white text-sm focus:ring-2 focus:ring-primary"
                        >
                            ...
                            <option value="{{ $servicio['id'] }}">
                                ...
                                @if($servicio['tiene_medidor'])
                                    (Medidor) — L. {{ number_format($servicio['precio_por_unidad_de_medida'], 2) }}/u
                                @else
                        ...
                        <button
                            ...
                            type="button"
                            class="px-6 py-2.5 bg-primary text-on-primary rounded-lg font-bold text-xs uppercase tracking-widest hover:opacity-90 transition-all flex items-center gap-2 whitespace-nowrap"
                        >
