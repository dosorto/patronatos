    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-xl max-w-md w-full mx-4">
            ...
            <p class="text-gray-600 dark:text-gray-400 mb-6 ml-13">
                ¿Estás seguro de eliminar <strong class="text-gray-900 dark:text-white">{{ $tipoActivoNombre }}</strong>?
            ...
            <div class="flex justify-end gap-3">
                <button
                    ...
                    class="px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-lg font-medium transition-colors">
                    Cancelar
                </button>
                <button
                    wire:click="delete"
