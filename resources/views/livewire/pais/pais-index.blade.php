    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-300 mt-1">
                Administra el registro de países y sus datos básicos
            </p>
        </div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200">
                            {{ $paises->total() }} {{ $paises->total() === 1 ? 'registro' : 'registros' }}
                        </span>
                    </div>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        @forelse($paises as $pais)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors cursor-pointer group"
                                onclick="window.location='{{ route('pais.show', $pais) }}'">

                                {{-- Nombre + ID debajo EXACTAMENTE como Personas --}}
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mr-3 shadow-sm group-hover:scale-110 transition-transform">
                                            <span class="text-white text-xs font-bold">
                                                {{ strtoupper(substr($pais->nombre, 0, 1)) }}
                                            </span>
                                        </div>
                                        <div>
                                ...
                                <td class="px-6 py-4" onclick="event.stopPropagation()">
                                    <div class="flex items-center space-x-2">
                                        ...
                                        @can('pais.delete')
                                            <button
                                                wire:click="confirmPaisDeletion('{{ $pais->id }}', '{{ $pais->nombre }}')"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full overflow-hidden border border-gray-200 dark:border-gray-700 anim-scale-in">
            ...
            <div class="p-6">
                ...
                <div class="text-center">
                    <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2">¿Eliminar País?</h3>
                    <p class="text-gray-600 dark:text-gray-400">
                        Estás a punto de eliminar <span class="font-semibold text-gray-900 dark:text-white">{{ $paisNameBeingDeleted }}</span>. 
