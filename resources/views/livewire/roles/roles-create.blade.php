<div class="max-w-4xl mx-auto p-6">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Crear Nuevo Rol</h1>
            <p class="text-gray-600 dark:text-gray-300">Selecciona los permisos para el nuevo rol</p>
        </div>
